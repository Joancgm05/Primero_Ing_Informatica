...
size\+\_\+t \mbox{\hyperlink{fibonacci__sum_8cc_ac425b2614dbfd00399b158067d4015d2}{Fibonacci\+Sum}} (const size\+\_\+t k\+Limit)
...
\mbox{\Hypertarget{fibonacci__sum_8cc_ac425b2614dbfd00399b158067d4015d2}\label{fibonacci__sum_8cc_ac425b2614dbfd00399b158067d4015d2}} 
\index{fibonacci\_sum.cc@{fibonacci\_sum.cc}!FibonacciSum@{FibonacciSum}}
\index{FibonacciSum@{FibonacciSum}!fibonacci\_sum.cc@{fibonacci\_sum.cc}}
...
Definition at line 55 of file fibonacci\+\_\+sum.\+cc.


\begin{DoxyCode}{0}
\DoxyCodeLine{55                                          \{}
\DoxyCodeLine{56   \textcolor{keywordtype}{size\_t} second\_to\_last\{0\},  \textcolor{comment}{// Second to last term}}
\DoxyCodeLine{57            last\{1\},          \textcolor{comment}{// Last term generated}}
\DoxyCodeLine{58            new\_term;         \textcolor{comment}{// New term of the serie}}
\DoxyCodeLine{59   \textcolor{keywordtype}{size\_t} \textcolor{keywordtype}{long} sum\{0\};        \textcolor{comment}{// Accumulated sum of the terms}}
\DoxyCodeLine{60 }
\DoxyCodeLine{61   \textcolor{keywordflow}{do} \{}
\DoxyCodeLine{62     new\_term = last + second\_to\_last;}
\DoxyCodeLine{63     \textcolor{keywordflow}{if} (new\_term \% 2 == 0) \{}
\DoxyCodeLine{64       sum += new\_term;}
\DoxyCodeLine{65     \}}
\DoxyCodeLine{66     \textcolor{comment}{// Uncomment for debug: print each new term}}
\DoxyCodeLine{67     \textcolor{comment}{// std::cout << "Term: " << new\_term << std::endl;}}
\DoxyCodeLine{68     second\_to\_last = last;}
\DoxyCodeLine{69     last = new\_term;}
\DoxyCodeLine{70   \} \textcolor{keywordflow}{while} (new\_term < kLimit);}
...
\DoxyCodeLine{41     \textcolor{keyword}{const} std::string kHelpText = \textcolor{stringliteral}{"Este programa calcula la suma de todos los términos pares de la \(\backslash\)}}
\DoxyCodeLine{42 \textcolor{stringliteral}{serie de Fibonacci que sean menores que un valor, que el usuario \(\backslash\)}}
\DoxyCodeLine{43 \textcolor{stringliteral}{ha de introducir por línea de comandos para la ejecución del programa"};}
\DoxyCodeLine{44     std::cout << kHelpText << std::endl;}
